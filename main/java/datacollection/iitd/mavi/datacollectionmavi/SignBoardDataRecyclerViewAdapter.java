...
import datacollection.iitd.mavi.datacollectionmavi.DataListFragment.OnListFragmentInteractionListener;
...
public class SignBoardDataRecyclerViewAdapter extends RecyclerView.Adapter<SignBoardDataRecyclerViewAdapter.ViewHolder> {
    ...
    public SignBoardDataRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
